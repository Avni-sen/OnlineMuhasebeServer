...
{
    //daha performanslı olması için EF içrisinden CompileAsyncQuery() metodunu kullandık.
    public static readonly Func<AppDbContext, string, Task<Company?>> GetCompanyByNameCompiled = EF.CompileAsyncQuery((AppDbContext context, string name) =>
